...
export default async function ProdBeOnePage() {
  ...
  return (
    <>
      <PageHero breadcrumbs={[{ label: t('common.home'), href: '/' }, { label: t('beone.bc') }]} title={t('beone.title')} description={t('beone.ph.desc')} />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: 80, alignItems: 'start' }}>
              ...
              <div style={{ background: 'var(--card)', padding: 20, border: '1px solid var(--border)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, flexWrap: 'wrap' }}>
                  <div style={{ background: 'rgba(0,180,216,0.1)', border: '1px solid rgba(0,180,216,0.3)', padding: '8px 14px', textAlign: 'center' }}>
                    <p style={{ fontFamily: 'var(--font-label)', fontSize: 11, color: 'var(--cyan)', fontWeight: 700 }}>PLC</p>
                    <p style={{ fontSize: 9, color: 'var(--muted)', marginTop: 2 }}>Ethernet</p>
                  </div>
                  <span style={{ color: 'var(--cyan)', fontSize: 16, fontWeight: 700 }}>⟺</span>
                  <div
                    style={{
                      background: 'linear-gradient(135deg,rgba(0,180,216,0.15),rgba(245,124,0,0.15))',
                      border: '1px solid rgba(0,180,216,0.5)',
                      padding: '8px 14px',
                      textAlign: 'center',
                    }}
                  >
                    <p style={{ fontFamily: 'var(--font-label)', fontSize: 11, color: 'var(--white)', fontWeight: 700 }}>BE-ONE</p>
                  ...
                  <div style={{ background: 'rgba(245,124,0,0.1)', border: '1px solid rgba(245,124,0,0.3)', padding: '8px 14px', textAlign: 'center' }}>
                    <p style={{ fontFamily: 'var(--font-label)', fontSize: 11, color: 'var(--orange)' }}>{t('beone.servo.amp')}</p>
                    <p style={{ fontSize: 9, color: 'var(--muted)', marginTop: 2 }}>RS232/422</p>
                  </div>
                  <span style={{ color: 'var(--orange)', fontSize: 14 }}>→</span>
                  <div style={{ background: 'rgba(245,124,0,0.1)', border: '1px solid rgba(245,124,0,0.3)', padding: '8px 14px', textAlign: 'center' }}>
                    <p style={{ fontFamily: 'var(--font-label)', fontSize: 11, color: 'var(--orange)' }}>{t('beone.servo.motor')}</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <div className="hz" style={{ border: '1px solid var(--border)' }}>
                ...
                <img
                  src="/images/beone-product.png"
                  alt="Be-One"
                  style={{ height: 320, objectFit: 'contain', background: 'var(--card)', padding: 24 }}
                />
              </div>
              <div style={{ background: 'rgba(0,180,216,0.05)', border: '1px solid rgba(0,180,216,0.12)', padding: '14px 18px' }}>
                <p style={{ fontSize: 11, color: 'var(--muted)', lineHeight: 1.8 }}>
                  <span style={{ color: 'var(--cyan)', fontFamily: 'var(--font-label)', fontSize: 10 }}>{t('beone.model.label')}</span>
                  <br />
                  MRJ4ARJ / MRJ2S_A
                  <br />
